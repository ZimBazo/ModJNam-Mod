...
public class CactusSheepEntity extends Animal implements IShearable, ICactusMob {
	...
	protected ResourceKey<LootTable> getDefaultLootTable() {
		if (this.getSheared())
			return ResourceKey.create(Registries.LOOT_TABLE, Reference.modLoc("entities/cactus_sheep"));
		else
			return ResourceKey.create(Registries.LOOT_TABLE, Reference.modLoc("entities/cactus_sheep1"));
	}
